...
import { getRemediationTicketsGlobal } from "@/lib/repositories/remediations";

interface GetRemediationTicketsGlobalQuery {
    page?: string;
    pageSize?: string;
    sortBy?: string;
    sortDir?: "asc" | "desc";
...
export default withApiHandler(async (req, res) => {
    const query = req.query as GetRemediationTicketsGlobalQuery;
    ...
    const data = await getRemediationTicketsGlobal(
        filters.customer,
        filters.status,
